...
import { Terminal, MessageSquare, Trash2, Code2, Brain, FileText, X } from 'lucide-react';
...
export function SlashCommandMenu({ query, commands, onSelect, onClose }: SlashCommandMenuProps) {
