...
- 2026-03-13: The design/system integration pass is now in place. The desktop renderer uses dedicated workbench/runtime stores, the visual layout has moved toward the chosen Cursor-like rail + sidebar + editor + bottom activity + right inspector structure, workspace/runtime IPC events now drive trace and timeline cards, and review/changes panes are backed by actual editor diffs instead of mock placeholders.
